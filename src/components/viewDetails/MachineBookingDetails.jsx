            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full lg:w-6/8 md:w-[70%] flex flex-col gap-4">
                    ...
                    <div className="w-full h-72 md:h-96 bg-gray-200 rounded-2xl overflow-hidden relative shadow-xl group">
                        ...
                        {/* Right Arrow to switch between images*/}
                        ...
                        {/* Image Counter */}
                        {/* if there is no images do not show this container */}
                        ...
                        {/* number of images (the left number start from one) / (the right number end wit last image)*/}
                            1 / 8
                        </div>
                    </div>

                    {/* Small Images show the total images of the machines and when i click on each one of them it shows up on the large image*/}
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-5">
                    ...
                    {/* Price */}
                    <div className="py-2">
                        {/* daily_rate make it replace the number */}
