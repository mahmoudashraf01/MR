...
const RenterDataForm1 = ({ data, setData, nextStep }) => {
        ...
        <div className="flex flex-col gap-2 font-medium">
          ...
          <div className="relative group">
            <img
              ...
              alt="phone icon"
              className={`absolute left-4 top-1/2 -translate-y-1/2
                    ${errors.contact_person ? "text-red-500" : "text-gray-400"}`}
            />
            ...
            <input
              ...
              className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl 
                    ${errors.contact_person ? "border-red-500" : "border-gray-200 focus:border-primaryBtn"}`}
            />
